...
class RNDeployments;
class AssignNodeDlg;
class Q_DECL_EXPORT LineManager : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    bool init();
    void setCurrentProject(const QString&, const QString&);
public slots:
    //菜单选项----
    void slotNewArea();
    void slotOpenArea();
...
private:
    ...
    //菜单管理------
    LMGRMenuManager    *m_menuManger;
    LMGRToolManager    *m_toolManager;
