...
QT_MOC_LITERAL(4, 38, 16) // "slotDisconnected"

    },
    "NodeQuery\0slotReadData\0\0slotConnected\0"
    "slotDisconnected"
};
...
void NodeQuery::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NodeQuery *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject NodeQuery::staticMetaObject = { {
    &QTcpSocket::staticMetaObject,
    qt_meta_stringdata_NodeQuery.data,
    qt_meta_data_NodeQuery,
    qt_static_metacall,
    nullptr,
    nullptr
} };
