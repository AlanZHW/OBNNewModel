...
void RNMGraphView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RNMGraphView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RNMGraphView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RNMGraphView::updateNodes)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RNMGraphView::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_RNMGraphView.data,
    qt_meta_data_RNMGraphView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_MOC_LITERAL(1, 12, 22), // "slotSaveInformFunction"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "NodeInfoDlg\0slotSaveInformFunction\0"
};
#undef QT_MOC_LITERAL
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NodeInfoDlg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotSaveInformFunction((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject NodeInfoDlg::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_NodeInfoDlg.data,
    qt_meta_data_NodeInfoDlg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
