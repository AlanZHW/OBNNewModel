    ...
    , ui(new Ui::ONBRetrieveAvailableNodes)
{
    ...
    connect(ui->pushButtonReset,  &QPushButton::clicked, this, &ONBRetrieveAvailableNodes::slotResetButtonClicked);
...
/// ======清除表格内容
void ONBRetrieveAvailableNodes::slotResetButtonClicked()
{
