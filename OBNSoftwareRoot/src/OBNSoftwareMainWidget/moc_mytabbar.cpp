...
QT_MOC_LITERAL(1, 9, 12), // "beginDragOut"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5) // "index"

    },
    "MyTabBar\0beginDragOut\0\0index"
};
...
void MyTabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyTabBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTabBar::beginDragOut)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTabBar::beginDragOut(int _t1)
{
